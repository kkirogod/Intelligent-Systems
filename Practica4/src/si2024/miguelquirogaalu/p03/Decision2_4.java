...
public class Decision2_4 extends Decision {
	...
	public NodoArbol getBranch(Mundo m) {
		...
		if (mundo.getNumEnfermeras() > 0 && mundo.getNumSanos() > 0 && (mundo
				.distanciaManhattan(mundo.enfermeraMasCercana()) < mundo.distanciaManhattan(mundo.sanoMasCercano())))
